...
`scripts/screenshots.sh` from the Linux desktop build in demo mode with the clock set to late morning
Beirut time. In demo mode the synthetic plants carry the names and coordinates of real solarised
