...
|----------------------------------|------------------------------|
| ![Governorates](docs/screenshots/dashboard_5.png) | ![Today](docs/screenshots/school_detail_3.png) |

| Dark theme |  |
|------------|--|
| ![Dashboard dark](docs/screenshots/dashboard_dark.png) | ![School detail dark](docs/screenshots/school_detail_dark.png) |

All 28 captures (light and dark, every screen scrolled) are in `docs/screenshots/`, generated by
